...
func RunPrecompiledContract(p PrecompiledContract, evm *EVM, input []byte, suppliedGas uint64, caller common.Address, value *big.Int, readonly bool) (ret []byte, remainingGas uint64, err error) {
...
func (c *dataCopy) Run(evm *EVM, in []byte, caller common.Address, value *big.Int, readonly bool) ([]byte, error) {
	return in, nil
}
